...
<CardGrid stagger>
	...
	/>
	<LinkCard
		title="Enterprise Cameras"
		description="MSDK 5.18 capture policy for M3E, M3T, and M3M, including verified survey source profiles."
		href={`${import.meta.env.BASE_URL}camera-platforms/`}
	/>
	<LinkCard
		title="Telemetry"
