...
import com.lyrebird.rc.data.source.VersionInfo
import com.lyrebird.rc.databinding.LayoutVersionInfoBinding
        ...
        binding.itemLatestVersionInfo.setOnClickListener {
            ...
            DialogUtil.showTwoButtonDialog(context, StringUtils.getResStr(R.string.news_dialog_content_tips),
                StringUtils.getResStr(R.string.news_dialog_btn_left), {
                    com.lyrebird.rc.util.Helper.startBrowser(context, StringUtils.getResStr(R.string.release_node_url))
