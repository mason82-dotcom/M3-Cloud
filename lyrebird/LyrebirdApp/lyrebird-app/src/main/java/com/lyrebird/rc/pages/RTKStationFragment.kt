...
import com.lyrebird.rc.data.DJIRTKBaseStationConnectInfo
import com.lyrebird.rc.data.RtkStationScanAdapter
import com.lyrebird.rc.databinding.FragStationRtkPageBinding
import com.lyrebird.rc.models.RTKStationVM
...
class RTKStationFragment : DJIFragment(), RtkStationScanAdapter.OnItemClickListener {
    ...
    private fun DJIRTKBaseStationConnectInfo.refresh(connectState: RTKStationConnetState?) {
        connectState?.let {
            LogUtils.i(com.lyrebird.rc.pages.RTKStationFragment.TAG, "connectState=$connectState")
