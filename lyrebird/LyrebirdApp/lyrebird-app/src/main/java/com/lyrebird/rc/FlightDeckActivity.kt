...
class FlightDeckActivity : DefaultLayoutActivity(), LyrebirdCommandHost {
    ...
    override fun readSettingsJson(): String {
        return buildString {
            ...
            append("\"appVersion\":\"${jsonEscape(BuildConfig.VERSION_NAME)}\",")
            append("\"buildGitSha\":\"${jsonEscape(BuildConfig.LYREBIRD_GIT_SHA)}\",")
            append("\"buildGitState\":\"${jsonEscape(BuildConfig.LYREBIRD_GIT_STATE)}\",")
            append("\"buildTime\":\"${jsonEscape(BuildConfig.LYREBIRD_BUILD_TIME)}\",")
            ...
            append("\"maxFlightHeightEffective\":${DroneController.getEffectiveMaxFlightHeight()},")
            append("\"maxFlightHeightStatus\":\"${DroneController.getMaxFlightHeightStatus()}\",")
            append("\"maxFlightDistance\":${DroneController.getMaxFlightDistance()},")
            append("\"maxFlightDistanceEffective\":${DroneController.getEffectiveMaxFlightDistance()},")
            append("\"maxFlightDistanceStatus\":\"${DroneController.getMaxFlightDistanceStatus()}\",")
            append("\"distanceLimitEnabled\":${DroneController.getDistanceLimitEnabled()},")
            append("\"distanceLimitEnabledEffective\":${DroneController.getEffectiveDistanceLimitEnabled()},")
            append("\"distanceLimitEnabledStatus\":\"${DroneController.getDistanceLimitEnabledStatus()}\",")
            ...
            append("\"appVersion\":\"identity\",")
            append("\"buildGitSha\":\"identity\",")
            append("\"buildGitState\":\"identity\",")
            append("\"buildTime\":\"identity\",")
            ...
            append("\"maxFlightHeightEffective\":\"flight\",")
            append("\"maxFlightHeightStatus\":\"flight\",")
            append("\"maxFlightDistance\":\"flight\",")
            append("\"maxFlightDistanceEffective\":\"flight\",")
            append("\"maxFlightDistanceStatus\":\"flight\",")
            append("\"distanceLimitEnabled\":\"flight\",")
            append("\"distanceLimitEnabledEffective\":\"flight\",")
            append("\"distanceLimitEnabledStatus\":\"flight\",")
