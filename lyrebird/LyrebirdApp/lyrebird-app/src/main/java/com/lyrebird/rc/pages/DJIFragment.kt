...
import com.lyrebird.rc.data.MAIN_FRAGMENT_PAGE_TITLE
import com.lyrebird.rc.models.MSDKInfoVm
import com.lyrebird.rc.util.wheel.PopupNumberPicker
import com.lyrebird.rc.util.wheel.PopupNumberPickerDouble
import com.lyrebird.rc.util.wheel.PopupNumberPickerPosition
...
open class DJIFragment : Fragment() {
    ...
    fun showDialog(title: String, msg: String = "", callback: com.lyrebird.rc.keyvalue.KeyItemActionListener<String>) {
